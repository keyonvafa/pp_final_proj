...
from pp.edward.inferences.map import MAP
from pp.edward.models import PointMass, RandomVariable
from pp.edward.util import get_session, get_variables
from pp.edward.util import copy, transform

try:
  from pp.edward.models import \
